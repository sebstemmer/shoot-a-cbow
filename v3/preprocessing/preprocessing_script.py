...
import logic.preprocessing_logic as preprocessing_logic
...
raw_text: str = open(utils.path_to_data + "raw/AllCombined.txt", "r").read()
...
sentences_in_words: list[list[str]] = logic.split_into_words(
    sentences
)
...
reduced_word_to_idx_count_vocab: dict[str, tuple[int, int]] = preprocessing_utils.reduce_vocab_via_window_count(
...
training_data: list[tuple[int, list[int]]] = preprocessing_utils.reduce_training_data(
...
word_to_idx_count_vocab: dict[str, tuple[int, int]] = preprocessing_utils.add_window_count_to_vocab(
    word_to_idx_count_vocab=reduced_word_to_idx_count_vocab,
...
with open(utils.path_to_data + "preprocessing/preprocessed_data.pickle", "wb") as handle:
    pickle.dump(
...
with open(utils.path_to_data + "/preprocessing/vocab.pickle", "wb") as handle:
    pickle.dump(
