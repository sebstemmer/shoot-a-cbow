import v3.preprocessing.logic.reduce_context_window_and_map_to_idx.reduce_context_window_and_map_to_idx as reduce_context_window_and_map_to_idx


def reduce_training_data_and_map_to_idx(
    ...
    return [
        (word_to_idx_count_vocab[sample[0]][0], reduced_context_window) for sample in full_training_data_in_words if (
            ...
            reduced_context_window := reduce_context_window_and_map_to_idx.reduce_context_window_and_map_to_idx(
